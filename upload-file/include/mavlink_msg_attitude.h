...
#define MAVLINK_MESSAGE_INFO_ATTITUDE { \
	...
	"ATTITUDE", \
	8, \
	{  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_attitude_t, time_boot_ms) }, \
...
static inline uint16_t mavlink_msg_attitude_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t timestamp, uint16_t deltatime, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed, float ground_distance)
{
...
static inline uint16_t mavlink_msg_attitude_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
							   mavlink_message_t* msg,uint64_t timestamp, uint16_t deltatime, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
	_mav_put_uint64_t(buf, 0, timestamp);
...
{
	return mavlink_msg_attitude_pack(system_id, component_id, msg, attitude->timestamp, attitude->timestamp, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed, attitude->ground_distance);
}
...
{
	return mavlink_msg_attitude_pack_chan(system_id, component_id, chan, msg, attitude->timestamp, attitude->deltatime, attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed, attitude->ground_distance);
}
...
static inline void mavlink_msg_attitude_send(mavlink_channel_t chan,  uint64_t timestamp, uint16_t deltatime, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
	_mav_put_uint64_t(buf, 0, timestamp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_attitude_send(chan, attitude->timestamp, attitude->deltatime ,attitude->roll, attitude->pitch, attitude->yaw, attitude->rollspeed, attitude->pitchspeed, attitude->yawspeed, attitude->ground_distance);
#else
 ...
 */
static inline void mavlink_msg_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint16_t deltatime, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed, float ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
static inline float mavlink_msg_attitude_ground_distance(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  32);
}

static inline float mavlink_msg_attitude_deltatime(const mavlink_message_t* msg)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	attitude->timestamp = mavlink_msg_attitude_get_time_boot_ms(msg);
	...
	attitude->ground_distance = mavlink_msg_attitude_ground_distance(msg);
	attitude->deltatime = mavlink_msg_attitude_deltatime(msg);
