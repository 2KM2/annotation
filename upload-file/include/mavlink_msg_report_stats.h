...
typedef struct __mavlink_report_stats_t {
 ...
 int8_t temperature; /*<  Temperature，unit:℃*/
} mavlink_report_stats_t;
#pragma pack()

#define MAVLINK_MSG_ID_REPORT_STATS_LEN 84
#define MAVLINK_MSG_ID_REPORT_STATS_MIN_LEN 84
#define MAVLINK_MSG_ID_207_LEN 84
#define MAVLINK_MSG_ID_207_MIN_LEN 84

#define MAVLINK_MSG_ID_REPORT_STATS_CRC 18
#define MAVLINK_MSG_ID_207_CRC 18
...
#define MAVLINK_MESSAGE_INFO_REPORT_STATS { \
    ...
    {  { "utc", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_report_stats_t, utc) }, \
         { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_report_stats_t, lat) }, \
         { "lon", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_report_stats_t, lon) }, \
         { "alt", NULL, MAVLINK_TYPE_INT16_T, 0, 16, offsetof(mavlink_report_stats_t, alt) }, \
         { "x", NULL, MAVLINK_TYPE_INT16_T, 0, 18, offsetof(mavlink_report_stats_t, x) }, \
         { "y", NULL, MAVLINK_TYPE_INT16_T, 0, 20, offsetof(mavlink_report_stats_t, y) }, \
         { "z", NULL, MAVLINK_TYPE_INT16_T, 0, 22, offsetof(mavlink_report_stats_t, z) }, \
         { "yaw", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_report_stats_t, yaw) }, \
         { "sensors_present", NULL, MAVLINK_TYPE_UINT16_T, 0, 26, offsetof(mavlink_report_stats_t, sensors_present) }, \
         { "sensors_health", NULL, MAVLINK_TYPE_UINT16_T, 0, 28, offsetof(mavlink_report_stats_t, sensors_health) }, \
         { "drone_id", NULL, MAVLINK_TYPE_UINT16_T, 0, 30, offsetof(mavlink_report_stats_t, drone_id) }, \
         { "firmware_version", NULL, MAVLINK_TYPE_UINT16_T, 0, 32, offsetof(mavlink_report_stats_t, firmware_version) }, \
         { "dance_version", NULL, MAVLINK_TYPE_UINT16_T, 0, 34, offsetof(mavlink_report_stats_t, dance_version) }, \
         { "dance_name", NULL, MAVLINK_TYPE_UINT8_T, 8, 36, offsetof(mavlink_report_stats_t, dance_name) }, \
         { "dance_md5", NULL, MAVLINK_TYPE_UINT8_T, 16, 44, offsetof(mavlink_report_stats_t, dance_md5) }, \
         { "product_id", NULL, MAVLINK_TYPE_UINT8_T, 16, 60, offsetof(mavlink_report_stats_t, product_id) }, \
         { "aux_token", NULL, MAVLINK_TYPE_UINT8_T, 0, 76, offsetof(mavlink_report_stats_t, aux_token) }, \
         { "time_token", NULL, MAVLINK_TYPE_UINT8_T, 0, 77, offsetof(mavlink_report_stats_t, time_token) }, \
         { "battery_volumn", NULL, MAVLINK_TYPE_UINT8_T, 0, 78, offsetof(mavlink_report_stats_t, battery_volumn) }, \
         { "formation_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 79, offsetof(mavlink_report_stats_t, formation_status) }, \
         { "rgb_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 80, offsetof(mavlink_report_stats_t, rgb_status) }, \
         { "acc_clibration_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 81, offsetof(mavlink_report_stats_t, acc_clibration_status) }, \
         { "mag_clibration_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 82, offsetof(mavlink_report_stats_t, mag_clibration_status) }, \
         { "temperature", NULL, MAVLINK_TYPE_INT8_T, 0, 83, offsetof(mavlink_report_stats_t, temperature) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_REPORT_STATS { \
                               ...
                               uint64_t utc, int32_t lat, int32_t lon, int16_t alt, int16_t x, int16_t y, int16_t z, uint16_t yaw, uint16_t sensors_present, uint16_t sensors_health, uint16_t drone_id, uint16_t firmware_version, uint16_t dance_version, const uint8_t *dance_name, const uint8_t *dance_md5, const uint8_t *product_id, uint8_t aux_token, uint8_t time_token, uint8_t battery_volumn, uint8_t formation_status, uint8_t rgb_status, uint8_t acc_clibration_status, uint8_t mag_clibration_status, int8_t temperature)
{
    ...
    _mav_put_int16_t(buf, 16, alt);
    _mav_put_int16_t(buf, 18, x);
    _mav_put_int16_t(buf, 20, y);
    _mav_put_int16_t(buf, 22, z);
    _mav_put_uint16_t(buf, 24, yaw);
    _mav_put_uint16_t(buf, 26, sensors_present);
    _mav_put_uint16_t(buf, 28, sensors_health);
    _mav_put_uint16_t(buf, 30, drone_id);
    _mav_put_uint16_t(buf, 32, firmware_version);
    _mav_put_uint16_t(buf, 34, dance_version);
    _mav_put_uint8_t(buf, 76, aux_token);
    _mav_put_uint8_t(buf, 77, time_token);
    _mav_put_uint8_t(buf, 78, battery_volumn);
    _mav_put_uint8_t(buf, 79, formation_status);
    _mav_put_uint8_t(buf, 80, rgb_status);
    _mav_put_uint8_t(buf, 81, acc_clibration_status);
    _mav_put_uint8_t(buf, 82, mag_clibration_status);
    _mav_put_int8_t(buf, 83, temperature);
    _mav_put_uint8_t_array(buf, 36, dance_name, 8);
    _mav_put_uint8_t_array(buf, 44, dance_md5, 16);
    _mav_put_uint8_t_array(buf, 60, product_id, 16);
    ...
    return mavlink_finalize_message(msg, system_id, component_id,MAVLINK_MSG_ID_REPORT_STATS_LEN,MAVLINK_MSG_ID_REPORT_STATS_LEN, MAVLINK_MSG_ID_REPORT_STATS_CRC);
}
                                   ...
                                   uint64_t utc,int32_t lat,int32_t lon,int16_t alt,int16_t x,int16_t y,int16_t z,uint16_t yaw,uint16_t sensors_present,uint16_t sensors_health,uint16_t drone_id,uint16_t firmware_version,uint16_t dance_version,const uint8_t *dance_name,const uint8_t *dance_md5,const uint8_t *product_id,uint8_t aux_token,uint8_t time_token,uint8_t battery_volumn,uint8_t formation_status,uint8_t rgb_status,uint8_t acc_clibration_status,uint8_t mag_clibration_status,int8_t temperature)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_REPORT_STATS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_REPORT_STATS_LEN,MAVLINK_MSG_ID_REPORT_STATS_LEN, MAVLINK_MSG_ID_REPORT_STATS_CRC);
}
...
{
    return mavlink_msg_report_stats_pack_chan(system_id, component_id, chan, msg, report_stats->utc, report_stats->lat, report_stats->lon, report_stats->alt, report_stats->x, report_stats->y, report_stats->z, report_stats->yaw, report_stats->sensors_present, report_stats->sensors_health, report_stats->drone_id, report_stats->firmware_version, report_stats->dance_version, report_stats->dance_name, report_stats->dance_md5, report_stats->product_id, report_stats->aux_token, report_stats->time_token, report_stats->battery_volumn, report_stats->formation_status, report_stats->rgb_status, report_stats->acc_clibration_status, report_stats->mag_clibration_status, report_stats->temperature);
}
...
static inline void mavlink_msg_report_stats_send(mavlink_channel_t chan, uint64_t utc, int32_t lat, int32_t lon, int16_t alt, int16_t x, int16_t y, int16_t z, uint16_t yaw, uint16_t sensors_present, uint16_t sensors_health, uint16_t drone_id, uint16_t firmware_version, uint16_t dance_version, const uint8_t *dance_name, const uint8_t *dance_md5, const uint8_t *product_id, uint8_t aux_token, uint8_t time_token, uint8_t battery_volumn, uint8_t formation_status, uint8_t rgb_status, uint8_t acc_clibration_status, uint8_t mag_clibration_status, int8_t temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_REPORT_STATS_LEN];
    _mav_put_uint64_t(buf, 0, utc);
    ...
    _mav_put_uint8_t_array(buf, 44, dance_md5, 16);
    _mav_put_uint8_t_array(buf, 60, product_id, 16);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_REPORT_STATS, buf, MAVLINK_MSG_ID_REPORT_STATS_LEN, MAVLINK_MSG_ID_REPORT_STATS_CRC);
#else
    mavlink_report_stats_t packet;
    packet.utc = utc;
    packet.lat = lat;
    ...
    mav_array_memcpy(packet.dance_md5, dance_md5, sizeof(uint8_t)*16);
    mav_array_memcpy(packet.product_id, product_id, sizeof(uint8_t)*16);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_REPORT_STATS, (const char *)&packet, MAVLINK_MSG_ID_REPORT_STATS_LEN, MAVLINK_MSG_ID_REPORT_STATS_CRC);
#endif
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_report_stats_send(chan, report_stats->utc, report_stats->lat, report_stats->lon, report_stats->alt, report_stats->x, report_stats->y, report_stats->z, report_stats->yaw, report_stats->sensors_present, report_stats->sensors_health, report_stats->drone_id, report_stats->firmware_version, report_stats->dance_version, report_stats->dance_name, report_stats->dance_md5, report_stats->product_id, report_stats->aux_token, report_stats->time_token, report_stats->battery_volumn, report_stats->formation_status, report_stats->rgb_status, report_stats->acc_clibration_status, report_stats->mag_clibration_status, report_stats->temperature);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_REPORT_STATS, (const char *)report_stats, MAVLINK_MSG_ID_REPORT_STATS_LEN, MAVLINK_MSG_ID_REPORT_STATS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_report_stats_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t utc, int32_t lat, int32_t lon, int16_t alt, int16_t x, int16_t y, int16_t z, uint16_t yaw, uint16_t sensors_present, uint16_t sensors_health, uint16_t drone_id, uint16_t firmware_version, uint16_t dance_version, const uint8_t *dance_name, const uint8_t *dance_md5, const uint8_t *product_id, uint8_t aux_token, uint8_t time_token, uint8_t battery_volumn, uint8_t formation_status, uint8_t rgb_status, uint8_t acc_clibration_status, uint8_t mag_clibration_status, int8_t temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint8_t_array(msg, dance_name, 8,  36);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, dance_md5, 16,  44);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, product_id, 16,  60);
}
