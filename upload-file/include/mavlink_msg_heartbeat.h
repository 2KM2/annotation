...
#define MAVLINK_MSG_ID_HEARTBEAT_CRC 47
#define MAVLINK_MSG_ID_0_CRC 47
...
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
    ...
    {  { "function_switch", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_heartbeat_t, function_switch) }, \
         ...
         { "autopilot", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_heartbeat_t, autopilot) }, \
         { "flight_mode", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_heartbeat_t, flight_mode) }, \
         { "system_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 11, offsetof(mavlink_heartbeat_t, system_status) }, \
...
static inline uint16_t mavlink_msg_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t function_switch, uint32_t flying_info, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t system_status, uint8_t mavlink_version)
{
    ...
    _mav_put_uint8_t(buf, 11, system_status);
    _mav_put_uint8_t(buf, 12, mavlink_version);
...
{
    return mavlink_msg_heartbeat_pack(system_id, component_id, msg, heartbeat->function_switch, heartbeat->flying_info, heartbeat->type, heartbeat->autopilot, heartbeat->flight_mode, heartbeat->system_status, heartbeat->mavlink_version);
}
...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, heartbeat->function_switch, heartbeat->flying_info, heartbeat->type, heartbeat->autopilot, heartbeat->flight_mode, heartbeat->system_status, heartbeat->mavlink_version);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, uint32_t function_switch, uint32_t flying_info, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t system_status, uint8_t mavlink_version)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HEARTBEAT_LEN];
    _mav_put_uint32_t(buf, 0, function_switch);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_heartbeat_send(chan, heartbeat->function_switch, heartbeat->flying_info, heartbeat->type, heartbeat->autopilot, heartbeat->flight_mode, heartbeat->system_status, heartbeat->mavlink_version);
#else
 ...
 */
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t function_switch, uint32_t flying_info, uint8_t type, uint8_t autopilot, uint8_t flight_mode, uint8_t system_status, uint8_t mavlink_version)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
