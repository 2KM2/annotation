...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_MIN_LEN 52
#define MAVLINK_MSG_ID_100_LEN 52
#define MAVLINK_MSG_ID_100_MIN_LEN 52
...
static inline uint16_t mavlink_msg_optical_flow_encodeX(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_optical_flow_t* optical_flow)
{
    memcpy(_MAV_PAYLOAD_NON_CONST(msg), optical_flow, MAVLINK_MSG_ID_OPTICAL_FLOW_LEN);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_optical_flow_send(chan, optical_flow->time_usec, optical_flow->flow_timespan,optical_flow->sensor_id, optical_flow->flow_x, optical_flow->flow_y,optical_flow->flow_rot ,optical_flow->flow_comp_m_x, optical_flow->flow_comp_m_y, optical_flow->rot_quality, optical_flow->quality, optical_flow->hover_flag, optical_flow->ground_distance);
#else
