...
typedef struct __mavlink_file_transfer_protocol_t {
 uint8_t state; /*< Network ID (0 for broadcast)*/
 uint8_t target_system; /*< System ID (0 for broadcast)*/
 uint8_t packet_num; /*< Component ID (0 for broadcast)*/
 uint8_t payload[128]; /*< Variable length payload. The length is defined by the remaining message length when subtracting the header and other fields.  The entire content of this block is opaque unless you understand any the encoding message_type.  The particular encoding used can be extension specific and might not always be documented as part of the mavlink specification.*/
} mavlink_file_transfer_protocol_t;


#define MAVLINK_MSG_ID_FILE_TRANSFER_PROTOCOL_LEN 131
#define MAVLINK_MSG_ID_FILE_TRANSFER_PROTOCOL_MIN_LEN 131
#define MAVLINK_MSG_ID_110_LEN 131
#define MAVLINK_MSG_ID_110_MIN_LEN 131
...
#define MAVLINK_MESSAGE_INFO_FILE_TRANSFER_PROTOCOL { \
   ...
   "FILE_TRANSFER_PROTOCOL", \
	4, \
	{  { "state", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_file_transfer_protocol_t, state) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_file_transfer_protocol_t, target_system) }, \
         { "packet_num", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_file_transfer_protocol_t, packet_num) }, \
         { "payload", NULL, MAVLINK_TYPE_UINT8_T, 128, 3, offsetof(mavlink_file_transfer_protocol_t, payload) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_FILE_TRANSFER_PROTOCOL { \
...
static inline uint16_t mavlink_msg_file_transfer_protocol_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
							   uint8_t state, uint8_t target_system, uint8_t packet_num, const uint8_t *payload)
{
	...
	_mav_put_uint8_t(buf, 2, packet_num);
	_mav_put_uint8_t_array(buf, 3, payload, 128);
...
{
	return mavlink_msg_file_transfer_protocol_pack(system_id, component_id, msg, file_transfer_protocol->state, file_transfer_protocol->target_system, file_transfer_protocol->packet_num, file_transfer_protocol->payload);
}
...
{
	return mavlink_msg_file_transfer_protocol_pack_chan(system_id, component_id, chan, msg, file_transfer_protocol->state, file_transfer_protocol->target_system, file_transfer_protocol->packet_num, file_transfer_protocol->payload);
}
...
static inline void mavlink_msg_file_transfer_protocol_send(mavlink_channel_t chan, uint8_t state, uint8_t target_system, uint8_t packet_num, const uint8_t *payload)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_FILE_TRANSFER_PROTOCOL_LEN];
	_mav_put_uint8_t(buf, 0, state);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_file_transfer_protocol_send(chan, file_transfer_protocol->state, file_transfer_protocol->target_system, file_transfer_protocol->packet_num, file_transfer_protocol->payload);
#else
 ...
 */
static inline void mavlink_msg_file_transfer_protocol_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t state, uint8_t target_system, uint8_t packet_num, const uint8_t *payload)
{
 ...
 */
static inline uint8_t mavlink_msg_file_transfer_protocol_get_state(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field packet_num from file_transfer_protocol message
 *
 * @return Component ID (0 for broadcast)
 */
static inline uint8_t mavlink_msg_file_transfer_protocol_get_packet_num(const mavlink_message_t* msg)
{
...
{
	return _MAV_RETURN_uint8_t_array(msg, payload, 128,  3);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	file_transfer_protocol->state = mavlink_msg_file_transfer_protocol_get_state(msg);
	file_transfer_protocol->target_system = mavlink_msg_file_transfer_protocol_get_target_system(msg);
	file_transfer_protocol->packet_num = mavlink_msg_file_transfer_protocol_get_packet_num(msg);
